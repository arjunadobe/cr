...
const Login = props => {
    ...
    const handleOtp = (event) => {
        setOtp(event);
        formApiOtp.current.setValue("otpvals", event)
    }
                            ...
                            <div className={defaultClasses.root}>
                                <div className={defaultClasses.login}>
                                    ...
                                    <div className={defaultClasses.tabframe}>
                                        ...
                                        <ul className={defaultClasses.nav + '' + defaultClasses[']nav-tabs']}
                                            className={defaultClasses['toggling-tabs']}>
                                            <li className="active">
                                                <a data-toggle="tab" href="#emailLogin">Email ID</a>
                                            </li>
                                            <li>
                                                <a data-toggle="tab" href="#mobileLogin">Mobile Number</a>
                                            </li>
                                        </ul>
                                            ...
                                            <div id="emailLogin" className="tab-pane in active">
                                                <div className={defaultClasses.tab}>
                                                    <Form
                                                        ...
                                                        <Field label="Email ID" className={defaultClasses.emailField}
                                                               required={true}>
                                                            <TextInput
                                                                field="email"
                                                                id="email"
                                                        ...
                                                        <div className={defaultClasses.passwordwithIcon}>
                                                            <Field label="Password"
                                                                   className={defaultClasses.passwordField}
                                                                   required={true}>
                                                                <Link to="/showforgotPassword" tabIndex="-1"
                                                                      className={defaultClasses.forgotpassword}>Forgot
                                                                    Password?
                                                                </Link>
                                                                <TextInput
                                                                    field="password"
                                                        ...
                                                        <div className={defaultClasses.rememberMe}>
                                                            ...
                                                            <Icon className={defaultClasses['info-icon']} src={Info}
                                                                  size={14}/>

                                                        </div>
                                                        <br/>
                                                        <div className={defaultClasses.terms}>By continuing, you agree
                                                            to Marketplace's
                                                        ...
                                                        <div className={defaultClasses.loginBtn}>
                                                            <Button type="submit" priority="high"
                                                                    className={defaultClasses.login}>
                                                                {'Login'}
                                                            </Button>
                                                        </div>
                                                ...
                                                <div className={defaultClasses.tab}>
                                                    <Form getApi={setFormOtpApi}>
                                                        ...
                                                        <Field label="Mobile Number"
                                                               className={defaultClasses.emailField} required={true}>
                                                            <TextInput
                                                                field="phone"
                                                                autoComplete="phone"
                                                                mask={maskInputPhone}
                                                        ...
                                                        <p id="enterPhoneValid" className={defaultClasses.hide}>Please
                                                        ...
                                                        <div id="enterOtp" className={defaultClasses.hide}>
                                                            ...
                                                            <p id="enterValidOtp" className={defaultClasses.hide}>Please
                                                                enter valid otp
                                                            </p>
